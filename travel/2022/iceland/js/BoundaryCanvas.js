// from https://github.com/aparshin/leaflet-boundary-canvas
(function () {
  "use strict";
  ...
  var ExtendMethods = {
    ...
    onRemove: function (map) {
      ...
      if (this.options.trackAttribution) {
        ...
        if (!this._attributionRemoved) {
          var attribution =
            L.TileLayer.BoundaryCanvas.prototype.getAttribution.call(this);
    ...
    _updateAttribution: function () {
      var geom = this._getOriginalMercBoundary(),
        ...
        mercBounds = L.bounds(
          this._map.project(mapBounds.getSouthWest(), 0),
          this._map.project(mapBounds.getNorthEast(), 0)
        ),
      ...
      if (this._attributionRemoved !== !!state.isOut) {
        ...
        this._map.attributionControl[
          state.isOut ? "removeAttribution" : "addAttribution"
        ](attribution);
    ...
    L.TileLayer.BoundaryCanvas = L.TileLayer.Canvas.extend({
      ...
      drawTile: function (canvas, tilePoint) {
        ...
        this._drawTileInternal(
          ...
          tilePoint,
          url,
          L.bind(this.tileDrawn, this, canvas)
        );
